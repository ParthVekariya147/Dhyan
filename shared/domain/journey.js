...
export const DEFAULT_JOURNEY = {
  ...
  [JOURNEY_PAGE.LEVEL2]: {
    ...
    */
    instruction:
      'અહીં દરેક લીલાનું Image , શીર્ષક અને વર્ણન ક્રમ પ્રમાણે આવશે. દરેક Image શાંતિથી દર્શન કરો અને એની સાથેનું વર્ણન તથા ક્રમ નંબર - ત્રણેય મનમાં રાખો. એક એક દર્શન ઓછામાં ઓછું પાંચ વાર નિરાંતે કરજો, જેથી લીલા મનમાં બરાબર યાદ રહી જાય. આગળના લેવલમાં ફક્ત ક્રમ અને ડિસ્ક્રિશન હશે Image નહીં હોઈ . Image દર્શન પૂરું થાય એટલે નીચે "આગળ" દબાવીને લેવલ ૩ પર જાઓ. Image ઉપ્પર ક્લિક કરી ને તેને ઝૂમ કરી શકાશે , અને તેની અંદર ઓટો સ્લાઇડશો નું બટન જોવા મળશે તે ના ઉપ્પર ક્લિક કરવા થી image ઑટોમૅટિકેલી બદલાશે . અત્યારે 3 સેકન્ડ માં image બદલે છે , તમારે આ સેકન્ડ વધારે / ઓછી કરવી હોઈ તેની માટે સેટિંગ માં ઓપ્શન આપવા માં આવ્યો છે . ',
