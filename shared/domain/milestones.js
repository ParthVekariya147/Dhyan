...
export const passedActivity = (code) => ({
  ...
  */
  line:
    ...
    'થાય એટલી વાર આપી શકશો - કોઈ મર્યાદા નથી, અને કંઈ બંધ થતું નથી. પૂરી થયેલી કસોટી ' +
...
export const allActivitiesDone = (level) => ({
  title: `અભિનંદન! 🎉 લેવલ ${level} ની બધી કસોટીઓ તમે પૂરી કરી લીધી`,
  line: 'આટલી ધીરજ રાખીને અને નિયમિત રીતે આગળ વધવું સહેલું નથી, પણ તમે એ કરી બતાવ્યું.',
  grow:
    'સાધનાનો રસ્તો અહીં પૂરો થતો નથી. જ્યારે મન થાય ત્યારે ફરી દર્શન કરી શકશો, અને દરેક ' +
    'વખતે એ દ્રશ્ય તમને વધારે પોતાનું લાગશે. જય સ્વામિનારાયણ 🙏',
});
